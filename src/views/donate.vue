<template>
    ...
    <div class="donate">
        <div class="wwdc__marketingfoobar">
            ...
            <span class="unicorn4">Support</span><br>
            <br>
            <span class="unicorn5">Who has seen the wind? </span><br>
            <span class="unicorn3">Neither I nor you. </span><br>
            <span class="unicorn6">But when the leaves hang trembling, </span><br>
            <span class="unicorn2">The wind is passing through.</span><br>
            <br>
            <span class="unicorn3">Who has seen the wind? </span><br>
            <span class="unicorn6">Neither you nor I. </span><br>
